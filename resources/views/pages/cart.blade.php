      ...
      <section class="store-cart">
        <div class="container">
              ...
              <table class="table table-borderless table-cart">
                ...
                <tbody>
                  ...
                  @foreach ($carts as $cart)
                    ...
                    <td style="width: 35%">
                      <div class="product-tittle">{{ number_format($cart->product->price) }}</div>
          ...
          <form action="{{ route('checkout') }}" id="locations" enctype="multipart/form-data" method="POST">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label for="adrress_one">Address 1</label>
                <input
                  type="text"
                  class="form-control"
                  id="adress_one"
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label for="adrress_two">Address 2</label>
                <input
                  type="text"
                  class="form-control"
                  id="adrress_two"
          ...
          <div class="row" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-4 col-md-2">
              <div class="product-title text-success">Rp. {{ number_format($totalPrice = $totalPrice) }}</div>

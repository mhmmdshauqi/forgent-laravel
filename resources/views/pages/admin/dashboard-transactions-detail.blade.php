...
<div class="section-content section-dashboard-home" data-aos="fade-up">
            <div class="container-fluid">
              ...
              <div class="dashboard-content" id="transactionDetails">
                        ...
                        <div class="row">
                          ...
                          <div class="col-12 col-md-8">
                            <div class="row">
                              ...
                              <div class="col-12 col-md-6">
                                <div class="product-title">Date Transaction</div>
                ...
                <form action="{{ route('admin-dashboard-transactions-update', $transaction->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="row">
                      <div class="col-12 col-md-6">
                        ...
                        <div class="product-subtitle">
                          {{ $transaction->transaction->user->adrress_one }}
                        </div>
                      </div>
                      <div class="col-12 col-md-6">
                        <div class="product-title">Address II</div>
                        <div class="product-subtitle">
                          {{ $transaction->transaction->user->adrress_two }}
                        </div>
                      </div>
                      <div class="col-12 col-md-6">

...
class ChangeNullableFieldAtUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('users', function (Blueprint $table) {
            $table->longText('adrress_one')->nullable()->change();
            $table->longText('adrress_two')->nullable()->change();
    ...
    {
        Schema::table('users', function (Blueprint $table) {
            $table->longText('adrress_one')->nullable(false)->change();
            $table->longText('adrress_two')->nullable(false)->change();
